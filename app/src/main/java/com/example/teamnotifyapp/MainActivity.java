...
//        influences how the system interprets and processes the spoken input
    ...
    private void sendNotification(String agendaText){
        ...
        Intent mobileActionIntent = new Intent(this, MobileActionReciever.class);
        mobileActionIntent.setAction("MOBILE_ACTION");
        PendingIntent mobileActionPendingIntent = PendingIntent.getBroadcast(this, 0, mobileActionIntent, PendingIntent.FLAG_IMMUTABLE);
        ...
        builder.addAction(R.drawable.ic_launcher_foreground, "Mobile Action", mobileActionPendingIntent);
